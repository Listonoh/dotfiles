...
# source ~/src/env/bin/activate  # commented out by conda initialize

function gr { git rebase -i HEAD~"$1"; git push --force-with-lease;}
...
function go() { git checkout NZN-${1}; }
alias gaaa="gaa && git commit --amend && gpsf"
